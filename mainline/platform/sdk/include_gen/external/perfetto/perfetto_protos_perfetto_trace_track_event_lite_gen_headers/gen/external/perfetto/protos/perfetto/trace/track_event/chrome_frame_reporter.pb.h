...
constexpr ChromeFrameReporter_FrameType ChromeFrameReporter_FrameType_FrameType_MIN = ChromeFrameReporter_FrameType_FORKED;
constexpr ChromeFrameReporter_FrameType ChromeFrameReporter_FrameType_FrameType_MAX = ChromeFrameReporter_FrameType_BACKFILL;
constexpr int ChromeFrameReporter_FrameType_FrameType_ARRAYSIZE = ChromeFrameReporter_FrameType_FrameType_MAX + 1;
...
inline const std::string& ChromeFrameReporter_FrameType_Name(T enum_t_value) {
  static_assert(::std::is_same<T, ChromeFrameReporter_FrameType>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function ChromeFrameReporter_FrameType_Name.");
  return ChromeFrameReporter_FrameType_Name(static_cast<ChromeFrameReporter_FrameType>(enum_t_value));
}
...
class ChromeFrameReporter final :
 ...
 public:
  ...
  static inline bool FrameDropReason_Parse(::PROTOBUF_NAMESPACE_ID::ConstStringParam name,
  ...
  static inline bool ScrollState_Parse(::PROTOBUF_NAMESPACE_ID::ConstStringParam name,
      ScrollState* value) {
    return ChromeFrameReporter_ScrollState_Parse(name, value);
  }

  typedef ChromeFrameReporter_FrameType FrameType;
  static constexpr FrameType FORKED =
    ChromeFrameReporter_FrameType_FORKED;
  static constexpr FrameType BACKFILL =
    ChromeFrameReporter_FrameType_BACKFILL;
  ...
  static constexpr FrameType FrameType_MIN =
    ChromeFrameReporter_FrameType_FrameType_MIN;
  static constexpr FrameType FrameType_MAX =
    ChromeFrameReporter_FrameType_FrameType_MAX;
  static constexpr int FrameType_ARRAYSIZE =
    ChromeFrameReporter_FrameType_FrameType_ARRAYSIZE;
  template<typename T>
  static inline const std::string& FrameType_Name(T enum_t_value) {
    ...
    return ChromeFrameReporter_FrameType_Name(enum_t_value);
  }
  ...
  void set_high_latency_contribution_stage(int index, const char* value, size_t size);
  ...
  void add_high_latency_contribution_stage(const char* value, size_t size);
  ...
  private:
  bool _internal_has_frame_source() const;
  public:
  ...
  private:
  bool _internal_has_frame_sequence() const;
  public:
  ...
  private:
  bool _internal_has_scroll_state() const;
  public:
  ...
  private:
  bool _internal_has_affects_smoothness() const;
  public:
  ...
  private:
  bool _internal_has_has_main_animation() const;
  public:
  ...
  private:
  bool _internal_has_has_compositor_animation() const;
  public:
  ...
  private:
  bool _internal_has_has_smooth_input_main() const;
  public:
  ...
  private:
  bool _internal_has_layer_tree_host_id() const;
  public:
  ...
  private:
  bool _internal_has_has_missing_content() const;
  public:
  ...
  private:
  bool _internal_has_has_high_latency() const;
  public:
...
inline bool ChromeFrameReporter::has_frame_source() const {
  return _internal_has_frame_source();
}
...
inline bool ChromeFrameReporter::has_frame_sequence() const {
  return _internal_has_frame_sequence();
}
...
inline bool ChromeFrameReporter::has_affects_smoothness() const {
  return _internal_has_affects_smoothness();
}
...
inline bool ChromeFrameReporter::has_scroll_state() const {
  return _internal_has_scroll_state();
}
...
inline bool ChromeFrameReporter::has_has_main_animation() const {
  return _internal_has_has_main_animation();
}
...
inline bool ChromeFrameReporter::has_has_compositor_animation() const {
  return _internal_has_has_compositor_animation();
}
...
inline bool ChromeFrameReporter::has_has_smooth_input_main() const {
  return _internal_has_has_smooth_input_main();
}
...
inline bool ChromeFrameReporter::has_has_missing_content() const {
  return _internal_has_has_missing_content();
}
...
inline bool ChromeFrameReporter::has_layer_tree_host_id() const {
  return _internal_has_layer_tree_host_id();
}
...
inline bool ChromeFrameReporter::has_has_high_latency() const {
  return _internal_has_has_high_latency();
}
...
inline const std::string& ChromeFrameReporter::_internal_high_latency_contribution_stage(int index) const {
  return _impl_.high_latency_contribution_stage_.Get(index);
}
...
inline std::string* ChromeFrameReporter::mutable_high_latency_contribution_stage(int index) {
  ...
  return _impl_.high_latency_contribution_stage_.Mutable(index);
}
inline void ChromeFrameReporter::set_high_latency_contribution_stage(int index, const std::string& value) {
  _impl_.high_latency_contribution_stage_.Mutable(index)->assign(value);
...
inline void ChromeFrameReporter::set_high_latency_contribution_stage(int index, std::string&& value) {
  _impl_.high_latency_contribution_stage_.Mutable(index)->assign(std::move(value));
  // @@protoc_insertion_point(field_set:perfetto.protos.ChromeFrameReporter.high_latency_contribution_stage)
}
...
inline void ChromeFrameReporter::set_high_latency_contribution_stage(int index, const char* value, size_t size) {
  _impl_.high_latency_contribution_stage_.Mutable(index)->assign(
...
inline std::string* ChromeFrameReporter::_internal_add_high_latency_contribution_stage() {
  return _impl_.high_latency_contribution_stage_.Add();
}
inline void ChromeFrameReporter::add_high_latency_contribution_stage(const std::string& value) {
  _impl_.high_latency_contribution_stage_.Add()->assign(value);
...
inline void ChromeFrameReporter::add_high_latency_contribution_stage(std::string&& value) {
  _impl_.high_latency_contribution_stage_.Add(std::move(value));
  // @@protoc_insertion_point(field_add:perfetto.protos.ChromeFrameReporter.high_latency_contribution_stage)
}
...
inline void ChromeFrameReporter::add_high_latency_contribution_stage(const char* value, size_t size) {
  _impl_.high_latency_contribution_stage_.Add()->assign(reinterpret_cast<const char*>(value), size);
