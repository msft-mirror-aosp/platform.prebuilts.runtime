...
class ProcessDescriptor final :
 ...
 public:
  ...
  static inline bool ChromeProcessType_Parse(::PROTOBUF_NAMESPACE_ID::ConstStringParam name,
  ...
  void set_process_labels(int index, const char* value, size_t size);
  ...
  void add_process_labels(const char* value, size_t size);
  ...
  private:
  bool _internal_has_chrome_process_type() const;
  public:
...
inline bool ProcessDescriptor::has_chrome_process_type() const {
  return _internal_has_chrome_process_type();
}
...
inline const std::string& ProcessDescriptor::_internal_process_labels(int index) const {
  return _impl_.process_labels_.Get(index);
}
...
inline std::string* ProcessDescriptor::mutable_process_labels(int index) {
  ...
  return _impl_.process_labels_.Mutable(index);
}
inline void ProcessDescriptor::set_process_labels(int index, const std::string& value) {
  _impl_.process_labels_.Mutable(index)->assign(value);
...
inline void ProcessDescriptor::set_process_labels(int index, std::string&& value) {
  _impl_.process_labels_.Mutable(index)->assign(std::move(value));
  // @@protoc_insertion_point(field_set:perfetto.protos.ProcessDescriptor.process_labels)
}
...
inline void ProcessDescriptor::set_process_labels(int index, const char* value, size_t size) {
  _impl_.process_labels_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
...
inline std::string* ProcessDescriptor::_internal_add_process_labels() {
  return _impl_.process_labels_.Add();
}
inline void ProcessDescriptor::add_process_labels(const std::string& value) {
  _impl_.process_labels_.Add()->assign(value);
...
inline void ProcessDescriptor::add_process_labels(std::string&& value) {
  _impl_.process_labels_.Add(std::move(value));
  // @@protoc_insertion_point(field_add:perfetto.protos.ProcessDescriptor.process_labels)
}
...
inline void ProcessDescriptor::add_process_labels(const char* value, size_t size) {
  _impl_.process_labels_.Add()->assign(reinterpret_cast<const char*>(value), size);
