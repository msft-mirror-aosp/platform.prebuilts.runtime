...
class ChromeLegacyIpc final :
 ...
 public:
  ...
  static inline bool MessageClass_Parse(::PROTOBUF_NAMESPACE_ID::ConstStringParam name,
      MessageClass* value) {
  ...
  private:
  bool _internal_has_message_class() const;
  public:
  ...
  private:
  bool _internal_has_message_line() const;
  public:
...
// optional .perfetto.protos.ChromeLegacyIpc.MessageClass message_class = 1;
inline bool ChromeLegacyIpc::_internal_has_message_class() const {
  bool value = (_impl_._has_bits_[0] & 0x00000001u) != 0;
  return value;
}
inline bool ChromeLegacyIpc::has_message_class() const {
  return _internal_has_message_class();
}
...
// optional uint32 message_line = 2;
inline bool ChromeLegacyIpc::_internal_has_message_line() const {
  bool value = (_impl_._has_bits_[0] & 0x00000002u) != 0;
  return value;
}
inline bool ChromeLegacyIpc::has_message_line() const {
  return _internal_has_message_line();
}
