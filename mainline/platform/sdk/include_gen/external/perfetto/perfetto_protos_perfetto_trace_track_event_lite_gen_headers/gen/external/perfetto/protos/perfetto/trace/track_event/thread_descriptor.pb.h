...
class ThreadDescriptor final :
 ...
 public:
  ...
  static inline bool ChromeThreadType_Parse(::PROTOBUF_NAMESPACE_ID::ConstStringParam name,
  ...
  private:
  bool _internal_has_chrome_thread_type() const;
  public:
  ...
  private:
  bool _internal_has_reference_timestamp_us() const;
  public:
  ...
  private:
  bool _internal_has_reference_thread_time_us() const;
  public:
  ...
  private:
  bool _internal_has_reference_thread_instruction_count() const;
  public:
...
inline std::string* ThreadDescriptor::release_thread_name() {
  ...
  _impl_._has_bits_[0] &= ~0x00000001u;
  auto* p = _impl_.thread_name_.Release();
...
inline bool ThreadDescriptor::has_chrome_thread_type() const {
  return _internal_has_chrome_thread_type();
}
...
inline bool ThreadDescriptor::has_reference_timestamp_us() const {
  return _internal_has_reference_timestamp_us();
}
...
inline bool ThreadDescriptor::has_reference_thread_time_us() const {
  return _internal_has_reference_thread_time_us();
}
...
inline bool ThreadDescriptor::has_reference_thread_instruction_count() const {
  return _internal_has_reference_thread_instruction_count();
}
