...
class StatsdTracingConfig final :
 ...
 public:
  ...
  StatsdTracingConfig* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<StatsdTracingConfig>(arena);
  }
  StatsdTracingConfig* New() const {
    return New(nullptr);
  }
...
class StatsdPullAtomConfig final :
 ...
 public:
  ...
  StatsdPullAtomConfig* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<StatsdPullAtomConfig>(arena);
  }
  StatsdPullAtomConfig* New() const {
    return New(nullptr);
  }
  void CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from)  final;
