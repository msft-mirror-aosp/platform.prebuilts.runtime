...
class TriggerRule_HistogramTrigger final :
 ...
 public:
  ...
  inline void Swap(TriggerRule_HistogramTrigger* other) {
  ...
  TriggerRule_HistogramTrigger* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<TriggerRule_HistogramTrigger>(arena);
  }
  TriggerRule_HistogramTrigger* New() const {
    return New(nullptr);
  }
...
class TriggerRule_RepeatingInterval final :
 ...
 public:
  ...
  inline void Swap(TriggerRule_RepeatingInterval* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  TriggerRule_RepeatingInterval* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<TriggerRule_RepeatingInterval>(arena);
  }
  TriggerRule_RepeatingInterval* New() const {
    return New(nullptr);
  }
  void CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from)  final;
...
class TriggerRule final :
 ...
 public:
  ...
  inline void Swap(TriggerRule* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  TriggerRule* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<TriggerRule>(arena);
  }
  TriggerRule* New() const {
    return New(nullptr);
  }
  void CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from)  final;
...
class NestedScenarioConfig final :
 ...
 public:
  ...
  inline void Swap(NestedScenarioConfig* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  NestedScenarioConfig* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<NestedScenarioConfig>(arena);
  }
  NestedScenarioConfig* New() const {
    return New(nullptr);
  }
  void CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from)  final;
...
class ChromeFieldTracingConfig final :
 ...
 public:
  ...
  inline void Swap(ChromeFieldTracingConfig* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  ChromeFieldTracingConfig* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<ChromeFieldTracingConfig>(arena);
  }
  ChromeFieldTracingConfig* New() const {
    return New(nullptr);
  }
  void CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from)  final;
