...
class ProcessStats_FDInfo final :
 ...
 public:
  ...
  ProcessStats_FDInfo* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<ProcessStats_FDInfo>(arena);
  }
  ProcessStats_FDInfo* New() const {
    return New(nullptr);
  }
  void CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from)  final;
...
class ProcessStats_Process final :
 ...
 public:
  ...
  ProcessStats_Process* New() const {
    return New(nullptr);
  }
  void CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from)  final;
