...
inline std::string* Utsname::release_sysname() {
  ...
  _impl_._has_bits_[0] &= ~0x00000001u;
  auto* p = _impl_.sysname_.Release();
...
inline std::string* Utsname::release_machine() {
  ...
  _impl_._has_bits_[0] &= ~0x00000008u;
  auto* p = _impl_.machine_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
void SystemInfo::set_android_build_fingerprint(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000001u;
 _impl_.android_build_fingerprint_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline std::string* SystemInfo::release_android_build_fingerprint() {
  ...
  _impl_._has_bits_[0] &= ~0x00000001u;
  auto* p = _impl_.android_build_fingerprint_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
inline void SystemInfo::set_allocated_android_build_fingerprint(std::string* android_build_fingerprint) {
  ...
  _impl_.android_build_fingerprint_.SetAllocated(android_build_fingerprint, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.android_build_fingerprint_.IsDefault()) {
    _impl_.android_build_fingerprint_.Set("", GetArenaForAllocation());
  }
