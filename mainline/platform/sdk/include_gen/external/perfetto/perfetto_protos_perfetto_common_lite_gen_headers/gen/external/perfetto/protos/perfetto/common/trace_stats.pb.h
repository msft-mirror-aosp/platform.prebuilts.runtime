...
class TraceStats_BufferStats final :
 ...
 public:
  ...
  TraceStats_BufferStats* New() const {
    return New(nullptr);
  }
...
class TraceStats_WriterStats final :
 ...
 public:
  ...
  TraceStats_WriterStats* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<TraceStats_WriterStats>(arena);
  }
  TraceStats_WriterStats* New() const {
    return New(nullptr);
  }
  void CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from)  final;
...
class TraceStats_FilterStats final :
 ...
 public:
  ...
  TraceStats_FilterStats* New() const {
    return New(nullptr);
  }
  void CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from)  final;
