...
constexpr PerfEvents_Counter PerfEvents_Counter_Counter_MAX = PerfEvents_Counter_SW_DUMMY;
...
constexpr PerfEvents_PerfClock PerfEvents_PerfClock_PerfClock_MIN = PerfEvents_PerfClock_UNKNOWN_PERF_CLOCK;
constexpr PerfEvents_PerfClock PerfEvents_PerfClock_PerfClock_MAX = PerfEvents_PerfClock_PERF_CLOCK_BOOTTIME;
constexpr int PerfEvents_PerfClock_PerfClock_ARRAYSIZE = PerfEvents_PerfClock_PerfClock_MAX + 1;
...
inline const std::string& PerfEvents_PerfClock_Name(T enum_t_value) {
  static_assert(::std::is_same<T, PerfEvents_PerfClock>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function PerfEvents_PerfClock_Name.");
  return PerfEvents_PerfClock_Name(static_cast<PerfEvents_PerfClock>(enum_t_value));
}
...
class PerfEvents_Timebase final :
 ...
 public:
  ...
  private:
  bool _internal_has_timestamp_clock() const;
  public:
...
class PerfEvents_Tracepoint final :
 ...
 public:
  ...
  PerfEvents_Tracepoint* New() const {
    return New(nullptr);
  }
  void CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from)  final;
...
class PerfEvents final :
 ...
 public:
  ...
  static constexpr Counter SW_TASK_CLOCK =
    PerfEvents_Counter_SW_TASK_CLOCK;
  static constexpr Counter SW_CONTEXT_SWITCHES =
    PerfEvents_Counter_SW_CONTEXT_SWITCHES;
  static constexpr Counter SW_CPU_MIGRATIONS =
    PerfEvents_Counter_SW_CPU_MIGRATIONS;
  static constexpr Counter SW_PAGE_FAULTS_MIN =
    PerfEvents_Counter_SW_PAGE_FAULTS_MIN;
  static constexpr Counter SW_PAGE_FAULTS_MAJ =
    PerfEvents_Counter_SW_PAGE_FAULTS_MAJ;
  static constexpr Counter SW_ALIGNMENT_FAULTS =
    PerfEvents_Counter_SW_ALIGNMENT_FAULTS;
  static constexpr Counter SW_EMULATION_FAULTS =
    PerfEvents_Counter_SW_EMULATION_FAULTS;
  static constexpr Counter SW_DUMMY =
    PerfEvents_Counter_SW_DUMMY;
  ...
  static constexpr Counter HW_CACHE_REFERENCES =
    PerfEvents_Counter_HW_CACHE_REFERENCES;
  static constexpr Counter HW_CACHE_MISSES =
    PerfEvents_Counter_HW_CACHE_MISSES;
  static constexpr Counter HW_BRANCH_INSTRUCTIONS =
    PerfEvents_Counter_HW_BRANCH_INSTRUCTIONS;
  static constexpr Counter HW_BRANCH_MISSES =
    PerfEvents_Counter_HW_BRANCH_MISSES;
  static constexpr Counter HW_BUS_CYCLES =
    PerfEvents_Counter_HW_BUS_CYCLES;
  static constexpr Counter HW_STALLED_CYCLES_FRONTEND =
    PerfEvents_Counter_HW_STALLED_CYCLES_FRONTEND;
  static constexpr Counter HW_STALLED_CYCLES_BACKEND =
    PerfEvents_Counter_HW_STALLED_CYCLES_BACKEND;
  static constexpr Counter HW_REF_CPU_CYCLES =
    PerfEvents_Counter_HW_REF_CPU_CYCLES;
  ...
  static inline bool Counter_Parse(::PROTOBUF_NAMESPACE_ID::ConstStringParam name,
      Counter* value) {
    return PerfEvents_Counter_Parse(name, value);
  }

  typedef PerfEvents_PerfClock PerfClock;
  static constexpr PerfClock UNKNOWN_PERF_CLOCK =
    PerfEvents_PerfClock_UNKNOWN_PERF_CLOCK;
  static constexpr PerfClock PERF_CLOCK_REALTIME =
    PerfEvents_PerfClock_PERF_CLOCK_REALTIME;
  static constexpr PerfClock PERF_CLOCK_MONOTONIC =
    PerfEvents_PerfClock_PERF_CLOCK_MONOTONIC;
  static constexpr PerfClock PERF_CLOCK_MONOTONIC_RAW =
    PerfEvents_PerfClock_PERF_CLOCK_MONOTONIC_RAW;
  static constexpr PerfClock PERF_CLOCK_BOOTTIME =
    PerfEvents_PerfClock_PERF_CLOCK_BOOTTIME;
  static inline bool PerfClock_IsValid(int value) {
    return PerfEvents_PerfClock_IsValid(value);
  }
  static constexpr PerfClock PerfClock_MIN =
    PerfEvents_PerfClock_PerfClock_MIN;
  static constexpr PerfClock PerfClock_MAX =
    PerfEvents_PerfClock_PerfClock_MAX;
  static constexpr int PerfClock_ARRAYSIZE =
    PerfEvents_PerfClock_PerfClock_ARRAYSIZE;
  template<typename T>
  static inline const std::string& PerfClock_Name(T enum_t_value) {
    static_assert(::std::is_same<T, PerfClock>::value ||
      ::std::is_integral<T>::value,
      "Incorrect type passed to function PerfClock_Name.");
    return PerfEvents_PerfClock_Name(enum_t_value);
  }
  static inline bool PerfClock_Parse(::PROTOBUF_NAMESPACE_ID::ConstStringParam name,
      PerfClock* value) {
...
inline bool PerfEvents_Timebase::has_timestamp_clock() const {
  return _internal_has_timestamp_clock();
}
