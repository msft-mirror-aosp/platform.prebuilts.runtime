...
class ObservableEvents_DataSourceInstanceStateChange final :
 ...
 public:
  ...
  ObservableEvents_DataSourceInstanceStateChange* New() const {
    return New(nullptr);
  }
...
class ObservableEvents_CloneTriggerHit final :
 ...
 public:
  ...
  inline void Swap(ObservableEvents_CloneTriggerHit* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  ObservableEvents_CloneTriggerHit* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<ObservableEvents_CloneTriggerHit>(arena);
  }
  ObservableEvents_CloneTriggerHit* New() const {
    return New(nullptr);
  }
  void CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from)  final;
