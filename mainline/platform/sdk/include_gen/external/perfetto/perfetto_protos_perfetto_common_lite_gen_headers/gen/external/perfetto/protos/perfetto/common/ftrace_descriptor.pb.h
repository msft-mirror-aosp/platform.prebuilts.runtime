...
class FtraceDescriptor_AtraceCategory final :
 ...
 public:
  ...
  inline void Swap(FtraceDescriptor_AtraceCategory* other) {
  ...
  FtraceDescriptor_AtraceCategory* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<FtraceDescriptor_AtraceCategory>(arena);
  }
  FtraceDescriptor_AtraceCategory* New() const {
    return New(nullptr);
  }
...
class FtraceDescriptor final :
 ...
 public:
  ...
  inline void Swap(FtraceDescriptor* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  FtraceDescriptor* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<FtraceDescriptor>(arena);
  }
  FtraceDescriptor* New() const {
    return New(nullptr);
  }
  void CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from)  final;
