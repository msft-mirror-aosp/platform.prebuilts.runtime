...
class TracingServiceState_Producer final :
 ...
 public:
  ...
  TracingServiceState_Producer* New() const {
    return New(nullptr);
  }
...
class TracingServiceState_DataSource final :
 ...
 public:
  ...
  TracingServiceState_DataSource* New() const {
    return New(nullptr);
  }
  void CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from)  final;
...
class TracingServiceState_TracingSession final :
 ...
 public:
  ...
  inline void Swap(TracingServiceState_TracingSession* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  TracingServiceState_TracingSession* New() const {
    return New(nullptr);
  }
  void CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from)  final;
