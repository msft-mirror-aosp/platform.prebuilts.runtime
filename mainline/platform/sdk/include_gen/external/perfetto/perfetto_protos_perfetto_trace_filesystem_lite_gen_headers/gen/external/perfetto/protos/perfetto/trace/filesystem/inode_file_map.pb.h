...
class InodeFileMap_Entry final :
 ...
 public:
  ...
  private:
  bool _internal_has_inode_number() const;
  public:
...
class InodeFileMap final :
 ...
 public:
  ...
  private:
  bool _internal_has_block_device_id() const;
  public:
...
// optional uint64 inode_number = 1;
inline bool InodeFileMap_Entry::_internal_has_inode_number() const {
  bool value = (_impl_._has_bits_[0] & 0x00000001u) != 0;
  return value;
}
inline bool InodeFileMap_Entry::has_inode_number() const {
  return _internal_has_inode_number();
}
...
// optional .perfetto.protos.InodeFileMap.Entry.Type type = 3;
inline bool InodeFileMap_Entry::_internal_has_type() const {
...
// optional uint64 block_device_id = 1;
inline bool InodeFileMap::_internal_has_block_device_id() const {
  bool value = (_impl_._has_bits_[0] & 0x00000001u) != 0;
  return value;
}
inline bool InodeFileMap::has_block_device_id() const {
  return _internal_has_block_device_id();
}
...
inline const std::string& InodeFileMap::_internal_mount_points(int index) const {
  return _impl_.mount_points_.Get(index);
}
...
inline std::string* InodeFileMap::mutable_mount_points(int index) {
  ...
  return _impl_.mount_points_.Mutable(index);
}
inline void InodeFileMap::set_mount_points(int index, const std::string& value) {
  _impl_.mount_points_.Mutable(index)->assign(value);
...
inline void InodeFileMap::set_mount_points(int index, std::string&& value) {
  _impl_.mount_points_.Mutable(index)->assign(std::move(value));
  // @@protoc_insertion_point(field_set:perfetto.protos.InodeFileMap.mount_points)
}
...
inline void InodeFileMap::set_mount_points(int index, const char* value, size_t size) {
  _impl_.mount_points_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
...
inline std::string* InodeFileMap::_internal_add_mount_points() {
  return _impl_.mount_points_.Add();
}
inline void InodeFileMap::add_mount_points(const std::string& value) {
  _impl_.mount_points_.Add()->assign(value);
...
inline void InodeFileMap::add_mount_points(std::string&& value) {
  _impl_.mount_points_.Add(std::move(value));
  // @@protoc_insertion_point(field_add:perfetto.protos.InodeFileMap.mount_points)
}
...
inline void InodeFileMap::add_mount_points(const char* value, size_t size) {
  _impl_.mount_points_.Add()->assign(reinterpret_cast<const char*>(value), size);
