...
class RemoteClockSync_SyncedClocks final :
 ...
 public:
  ...
  inline void Swap(RemoteClockSync_SyncedClocks* other) {
  ...
  RemoteClockSync_SyncedClocks* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<RemoteClockSync_SyncedClocks>(arena);
  }
  RemoteClockSync_SyncedClocks* New() const {
    return New(nullptr);
  }
...
class RemoteClockSync final :
 ...
 public:
  ...
  inline void Swap(RemoteClockSync* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  RemoteClockSync* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<RemoteClockSync>(arena);
  }
  RemoteClockSync* New() const {
    return New(nullptr);
  }
  void CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from)  final;
