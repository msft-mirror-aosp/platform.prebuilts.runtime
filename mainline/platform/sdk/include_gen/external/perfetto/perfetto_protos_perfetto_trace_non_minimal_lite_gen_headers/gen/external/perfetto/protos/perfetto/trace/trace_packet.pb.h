...
class TracePacket final :
 ...
 public:
  ...
  bool has_surfaceflinger_layers_snapshot() const;
  private:
  bool _internal_has_surfaceflinger_layers_snapshot() const;
  public:
  void clear_surfaceflinger_layers_snapshot();
  const ::perfetto::protos::LayersSnapshotProto& surfaceflinger_layers_snapshot() const;
  PROTOBUF_NODISCARD ::perfetto::protos::LayersSnapshotProto* release_surfaceflinger_layers_snapshot();
  ::perfetto::protos::LayersSnapshotProto* mutable_surfaceflinger_layers_snapshot();
  void set_allocated_surfaceflinger_layers_snapshot(::perfetto::protos::LayersSnapshotProto* surfaceflinger_layers_snapshot);
  private:
  const ::perfetto::protos::LayersSnapshotProto& _internal_surfaceflinger_layers_snapshot() const;
  ::perfetto::protos::LayersSnapshotProto* _internal_mutable_surfaceflinger_layers_snapshot();
  public:
  void unsafe_arena_set_allocated_surfaceflinger_layers_snapshot(
      ::perfetto::protos::LayersSnapshotProto* surfaceflinger_layers_snapshot);
  ::perfetto::protos::LayersSnapshotProto* unsafe_arena_release_surfaceflinger_layers_snapshot();

  // .perfetto.protos.TransactionTraceEntry surfaceflinger_transactions = 94;
  bool has_surfaceflinger_transactions() const;
  private:
  bool _internal_has_surfaceflinger_transactions() const;
  public:
  void clear_surfaceflinger_transactions();
  const ::perfetto::protos::TransactionTraceEntry& surfaceflinger_transactions() const;
  PROTOBUF_NODISCARD ::perfetto::protos::TransactionTraceEntry* release_surfaceflinger_transactions();
  ::perfetto::protos::TransactionTraceEntry* mutable_surfaceflinger_transactions();
  void set_allocated_surfaceflinger_transactions(::perfetto::protos::TransactionTraceEntry* surfaceflinger_transactions);
  private:
  const ::perfetto::protos::TransactionTraceEntry& _internal_surfaceflinger_transactions() const;
  ::perfetto::protos::TransactionTraceEntry* _internal_mutable_surfaceflinger_transactions();
  public:
  void unsafe_arena_set_allocated_surfaceflinger_transactions(
...
inline void TracePacket::set_synchronization_marker(ArgT0&& arg0, ArgT... args) {
  ...
  _impl_.data_.synchronization_marker_.SetBytes( static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void TracePacket::set_allocated_synchronization_marker(std::string* synchronization_marker) {
  ...
  if (synchronization_marker != nullptr) {
    set_has_synchronization_marker();
    _impl_.data_.synchronization_marker_.InitAllocated(synchronization_marker, GetArenaForAllocation());
  }
...
inline void TracePacket::set_compressed_packets(ArgT0&& arg0, ArgT... args) {
  ...
  _impl_.data_.compressed_packets_.SetBytes( static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void TracePacket::set_allocated_compressed_packets(std::string* compressed_packets) {
  ...
  if (compressed_packets != nullptr) {
    set_has_compressed_packets();
    _impl_.data_.compressed_packets_.InitAllocated(compressed_packets, GetArenaForAllocation());
  }
...
inline bool TracePacket::has_surfaceflinger_layers_snapshot() const {
  return _internal_has_surfaceflinger_layers_snapshot();
}
inline void TracePacket::set_has_surfaceflinger_layers_snapshot() {
  _impl_._oneof_case_[0] = kSurfaceflingerLayersSnapshot;
}
inline ::perfetto::protos::LayersSnapshotProto* TracePacket::release_surfaceflinger_layers_snapshot() {
  ...
  if (_internal_has_surfaceflinger_layers_snapshot()) {
    clear_has_data();
    ::perfetto::protos::LayersSnapshotProto* temp = _impl_.data_.surfaceflinger_layers_snapshot_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
...
inline const ::perfetto::protos::LayersSnapshotProto& TracePacket::_internal_surfaceflinger_layers_snapshot() const {
  return _internal_has_surfaceflinger_layers_snapshot()
      ...
      : reinterpret_cast< ::perfetto::protos::LayersSnapshotProto&>(::perfetto::protos::_LayersSnapshotProto_default_instance_);
}
inline const ::perfetto::protos::LayersSnapshotProto& TracePacket::surfaceflinger_layers_snapshot() const {
...
inline ::perfetto::protos::LayersSnapshotProto* TracePacket::unsafe_arena_release_surfaceflinger_layers_snapshot() {
...
inline void TracePacket::unsafe_arena_set_allocated_surfaceflinger_layers_snapshot(::perfetto::protos::LayersSnapshotProto* surfaceflinger_layers_snapshot) {
  clear_data();
...
inline ::perfetto::protos::LayersSnapshotProto* TracePacket::_internal_mutable_surfaceflinger_layers_snapshot() {
  if (!_internal_has_surfaceflinger_layers_snapshot()) {
    clear_data();
    set_has_surfaceflinger_layers_snapshot();
    _impl_.data_.surfaceflinger_layers_snapshot_ = CreateMaybeMessage< ::perfetto::protos::LayersSnapshotProto >(GetArenaForAllocation());
  }
  return _impl_.data_.surfaceflinger_layers_snapshot_;
}
inline ::perfetto::protos::LayersSnapshotProto* TracePacket::mutable_surfaceflinger_layers_snapshot() {
...
inline bool TracePacket::has_surfaceflinger_transactions() const {
  return _internal_has_surfaceflinger_transactions();
}
inline void TracePacket::set_has_surfaceflinger_transactions() {
  _impl_._oneof_case_[0] = kSurfaceflingerTransactions;
}
inline ::perfetto::protos::TransactionTraceEntry* TracePacket::release_surfaceflinger_transactions() {
  ...
  if (_internal_has_surfaceflinger_transactions()) {
    clear_has_data();
    ::perfetto::protos::TransactionTraceEntry* temp = _impl_.data_.surfaceflinger_transactions_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
...
inline const ::perfetto::protos::TransactionTraceEntry& TracePacket::_internal_surfaceflinger_transactions() const {
  return _internal_has_surfaceflinger_transactions()
      ...
      : reinterpret_cast< ::perfetto::protos::TransactionTraceEntry&>(::perfetto::protos::_TransactionTraceEntry_default_instance_);
}
inline const ::perfetto::protos::TransactionTraceEntry& TracePacket::surfaceflinger_transactions() const {
...
inline ::perfetto::protos::TransactionTraceEntry* TracePacket::unsafe_arena_release_surfaceflinger_transactions() {
...
inline void TracePacket::unsafe_arena_set_allocated_surfaceflinger_transactions(::perfetto::protos::TransactionTraceEntry* surfaceflinger_transactions) {
  clear_data();
...
inline ::perfetto::protos::TransactionTraceEntry* TracePacket::_internal_mutable_surfaceflinger_transactions() {
  if (!_internal_has_surfaceflinger_transactions()) {
    clear_data();
    set_has_surfaceflinger_transactions();
    _impl_.data_.surfaceflinger_transactions_ = CreateMaybeMessage< ::perfetto::protos::TransactionTraceEntry >(GetArenaForAllocation());
  }
  return _impl_.data_.surfaceflinger_transactions_;
}
inline ::perfetto::protos::TransactionTraceEntry* TracePacket::mutable_surfaceflinger_transactions() {
