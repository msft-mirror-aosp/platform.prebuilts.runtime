...
class UiState_HighlightProcess final :
 ...
 public:
  ...
  UiState_HighlightProcess* New() const {
    return New(nullptr);
  }
...
class UiState final :
 ...
 public:
  ...
  private:
  bool _internal_has_highlight_process() const;
  public:
  ...
  private:
  bool _internal_has_timeline_start_ts() const;
  public:
  ...
  private:
  bool _internal_has_timeline_end_ts() const;
  public:
...
// uint32 pid = 1;
inline bool UiState_HighlightProcess::_internal_has_pid() const {
...
// string cmdline = 2;
inline bool UiState_HighlightProcess::_internal_has_cmdline() const {
...
inline void UiState_HighlightProcess::set_cmdline(ArgT0&& arg0, ArgT... args) {
  if (!_internal_has_cmdline()) {
    clear_selector();
    set_has_cmdline();
    _impl_.selector_.cmdline_.InitDefault();
  }
  _impl_.selector_.cmdline_.Set( static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void UiState_HighlightProcess::set_allocated_cmdline(std::string* cmdline) {
  ...
  if (cmdline != nullptr) {
    set_has_cmdline();
    _impl_.selector_.cmdline_.InitAllocated(cmdline, GetArenaForAllocation());
  }
...
// optional int64 timeline_start_ts = 1;
inline bool UiState::_internal_has_timeline_start_ts() const {
  bool value = (_impl_._has_bits_[0] & 0x00000002u) != 0;
  return value;
}
inline bool UiState::has_timeline_start_ts() const {
  return _internal_has_timeline_start_ts();
}
...
// optional int64 timeline_end_ts = 2;
inline bool UiState::_internal_has_timeline_end_ts() const {
  bool value = (_impl_._has_bits_[0] & 0x00000004u) != 0;
  return value;
}
inline bool UiState::has_timeline_end_ts() const {
  return _internal_has_timeline_end_ts();
}
