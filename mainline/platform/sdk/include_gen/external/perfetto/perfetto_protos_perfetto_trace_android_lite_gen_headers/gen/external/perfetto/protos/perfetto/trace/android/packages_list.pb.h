...
class PackagesList_PackageInfo final :
 ...
 public:
  ...
  PackagesList_PackageInfo* New() const {
    return New(nullptr);
  }
  ...
  private:
  bool _internal_has_debuggable() const;
  public:
  ...
  private:
  bool _internal_has_profileable_from_shell() const;
  public:
...
inline bool PackagesList_PackageInfo::has_debuggable() const {
  return _internal_has_debuggable();
}
...
inline bool PackagesList_PackageInfo::has_profileable_from_shell() const {
  return _internal_has_profileable_from_shell();
}
