...
class PixelModemEvents final :
 ...
 public:
  ...
  inline void Swap(PixelModemEvents* other) {
  ...
  PixelModemEvents* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<PixelModemEvents>(arena);
  }
  PixelModemEvents* New() const {
    return New(nullptr);
  }
...
class PixelModemTokenDatabase final :
 ...
 public:
  ...
  inline void Swap(PixelModemTokenDatabase* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  PixelModemTokenDatabase* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<PixelModemTokenDatabase>(arena);
  }
  PixelModemTokenDatabase* New() const {
    return New(nullptr);
  }
  void CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from)  final;
