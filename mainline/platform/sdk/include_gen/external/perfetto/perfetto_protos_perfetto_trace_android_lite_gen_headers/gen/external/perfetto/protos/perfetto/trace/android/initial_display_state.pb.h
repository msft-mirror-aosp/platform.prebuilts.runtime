...
class InitialDisplayState final :
 ...
 public:
  ...
  private:
  bool _internal_has_display_state() const;
  public:
...
// optional int32 display_state = 1;
inline bool InitialDisplayState::_internal_has_display_state() const {
  bool value = (_impl_._has_bits_[0] & 0x00000002u) != 0;
  return value;
}
inline bool InitialDisplayState::has_display_state() const {
  return _internal_has_display_state();
}
...
// optional double brightness = 2;
inline bool InitialDisplayState::_internal_has_brightness() const {
