...
class AndroidLogPacket_LogEvent_Arg final :
 ...
 public:
  ...
  AndroidLogPacket_LogEvent_Arg* New() const {
    return New(nullptr);
  }
...
class AndroidLogPacket_LogEvent final :
 ...
 public:
  ...
  AndroidLogPacket_LogEvent* New() const {
    return New(nullptr);
  }
  void CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from)  final;
...
class AndroidLogPacket_Stats final :
 ...
 public:
  ...
  AndroidLogPacket_Stats* New() const {
    return New(nullptr);
  }
  void CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from)  final;
  ...
  private:
  bool _internal_has_num_total() const;
  public:
  ...
  private:
  bool _internal_has_num_failed() const;
  public:
  ...
  private:
  bool _internal_has_num_skipped() const;
  public:
...
inline bool AndroidLogPacket_Stats::has_num_total() const {
  return _internal_has_num_total();
}
...
inline bool AndroidLogPacket_Stats::has_num_failed() const {
  return _internal_has_num_failed();
}
...
inline bool AndroidLogPacket_Stats::has_num_skipped() const {
  return _internal_has_num_skipped();
}
