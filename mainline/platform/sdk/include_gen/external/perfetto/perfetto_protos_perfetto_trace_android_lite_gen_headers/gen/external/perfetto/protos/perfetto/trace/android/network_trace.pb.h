...
class NetworkPacketEvent final :
 ...
 public:
  ...
  NetworkPacketEvent* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<NetworkPacketEvent>(arena);
  }
  NetworkPacketEvent* New() const {
    return New(nullptr);
  }
...
class NetworkPacketBundle final :
 ...
 public:
  ...
  NetworkPacketBundle* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<NetworkPacketBundle>(arena);
  }
  NetworkPacketBundle* New() const {
    return New(nullptr);
  }
  void CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from)  final;
...
class NetworkPacketContext final :
 ...
 public:
  ...
  NetworkPacketContext* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<NetworkPacketContext>(arena);
  }
  NetworkPacketContext* New() const {
    return New(nullptr);
  }
  void CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from)  final;
