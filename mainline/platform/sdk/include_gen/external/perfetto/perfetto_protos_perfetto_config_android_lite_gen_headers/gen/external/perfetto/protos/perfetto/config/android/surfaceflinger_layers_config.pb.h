...
class SurfaceFlingerLayersConfig final :
 ...
 public:
  ...
  inline void Swap(SurfaceFlingerLayersConfig* other) {
  ...
  SurfaceFlingerLayersConfig* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<SurfaceFlingerLayersConfig>(arena);
  }
  SurfaceFlingerLayersConfig* New() const {
    return New(nullptr);
  }
