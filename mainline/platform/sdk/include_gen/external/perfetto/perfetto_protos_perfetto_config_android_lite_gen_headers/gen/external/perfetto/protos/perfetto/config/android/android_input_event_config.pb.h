...
class AndroidInputEventConfig_TraceRule final :
 ...
 public:
  ...
  inline void Swap(AndroidInputEventConfig_TraceRule* other) {
  ...
  AndroidInputEventConfig_TraceRule* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<AndroidInputEventConfig_TraceRule>(arena);
  }
  AndroidInputEventConfig_TraceRule* New() const {
    return New(nullptr);
  }
...
class AndroidInputEventConfig final :
 ...
 public:
  ...
  inline void Swap(AndroidInputEventConfig* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  AndroidInputEventConfig* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<AndroidInputEventConfig>(arena);
  }
  AndroidInputEventConfig* New() const {
    return New(nullptr);
  }
  void CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from)  final;
