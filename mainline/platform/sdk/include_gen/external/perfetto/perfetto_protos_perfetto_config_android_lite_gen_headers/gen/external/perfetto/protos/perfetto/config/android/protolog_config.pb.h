...
class ProtoLogConfig final :
 ...
 public:
  ...
  inline void Swap(ProtoLogConfig* other) {
  ...
  ProtoLogConfig* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<ProtoLogConfig>(arena);
  }
  ProtoLogConfig* New() const {
    return New(nullptr);
  }
  ...
  private:
  bool _internal_has_default_log_from_level() const;
  public:
...
class ProtoLogGroup final :
 ...
 public:
  ...
  inline void Swap(ProtoLogGroup* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  ProtoLogGroup* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<ProtoLogGroup>(arena);
  }
  ProtoLogGroup* New() const {
    return New(nullptr);
  }
  void CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from)  final;
...
// optional .perfetto.protos.ProtoLogLevel default_log_from_level = 3;
inline bool ProtoLogConfig::_internal_has_default_log_from_level() const {
  bool value = (_impl_._has_bits_[0] & 0x00000002u) != 0;
  return value;
}
inline bool ProtoLogConfig::has_default_log_from_level() const {
  return _internal_has_default_log_from_level();
}
