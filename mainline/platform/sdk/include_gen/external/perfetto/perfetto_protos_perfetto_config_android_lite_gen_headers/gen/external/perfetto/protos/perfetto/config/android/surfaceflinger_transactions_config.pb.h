...
class SurfaceFlingerTransactionsConfig final :
 ...
 public:
  ...
  inline void Swap(SurfaceFlingerTransactionsConfig* other) {
  ...
  SurfaceFlingerTransactionsConfig* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<SurfaceFlingerTransactionsConfig>(arena);
  }
  SurfaceFlingerTransactionsConfig* New() const {
    return New(nullptr);
  }
