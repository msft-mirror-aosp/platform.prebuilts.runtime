...
class ShellTransition_Target final :
 ...
 public:
  ...
  inline void Swap(ShellTransition_Target* other) {
  ...
  ShellTransition_Target* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<ShellTransition_Target>(arena);
  }
  ShellTransition_Target* New() const {
    return New(nullptr);
  }
...
class ShellTransition final :
 ...
 public:
  ...
  inline void Swap(ShellTransition* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  ShellTransition* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<ShellTransition>(arena);
  }
  ShellTransition* New() const {
    return New(nullptr);
  }
  void CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from)  final;
...
class ShellHandlerMappings final :
 ...
 public:
  ...
  inline void Swap(ShellHandlerMappings* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  ShellHandlerMappings* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<ShellHandlerMappings>(arena);
  }
  ShellHandlerMappings* New() const {
    return New(nullptr);
  }
  void CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from)  final;
...
class ShellHandlerMapping final :
 ...
 public:
  ...
  inline void Swap(ShellHandlerMapping* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  ShellHandlerMapping* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<ShellHandlerMapping>(arena);
  }
  ShellHandlerMapping* New() const {
    return New(nullptr);
  }
  void CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from)  final;
