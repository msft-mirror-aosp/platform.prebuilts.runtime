...
class CSwitchEtwEvent final :
 ...
 public:
  ...
  inline void Swap(CSwitchEtwEvent* other) {
  ...
  CSwitchEtwEvent* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<CSwitchEtwEvent>(arena);
  }
  CSwitchEtwEvent* New() const {
    return New(nullptr);
  }
...
class ReadyThreadEtwEvent final :
 ...
 public:
  ...
  inline void Swap(ReadyThreadEtwEvent* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  ReadyThreadEtwEvent* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<ReadyThreadEtwEvent>(arena);
  }
  ReadyThreadEtwEvent* New() const {
    return New(nullptr);
  }
  void CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from)  final;
