...
class ThermalExynosAcpmBulkFtraceEvent final :
 ...
 public:
  ...
  inline void Swap(ThermalExynosAcpmBulkFtraceEvent* other) {
  ...
  ThermalExynosAcpmBulkFtraceEvent* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<ThermalExynosAcpmBulkFtraceEvent>(arena);
  }
  ThermalExynosAcpmBulkFtraceEvent* New() const {
    return New(nullptr);
  }
...
class ThermalExynosAcpmHighOverheadFtraceEvent final :
 ...
 public:
  ...
  inline void Swap(ThermalExynosAcpmHighOverheadFtraceEvent* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  ThermalExynosAcpmHighOverheadFtraceEvent* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<ThermalExynosAcpmHighOverheadFtraceEvent>(arena);
  }
  ThermalExynosAcpmHighOverheadFtraceEvent* New() const {
    return New(nullptr);
  }
  void CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from)  final;
