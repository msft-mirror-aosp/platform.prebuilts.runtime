...
class DrmSchedJobFtraceEvent final :
 ...
 public:
  ...
  DrmSchedJobFtraceEvent* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<DrmSchedJobFtraceEvent>(arena);
  }
  DrmSchedJobFtraceEvent* New() const {
    return New(nullptr);
  }
...
class DrmRunJobFtraceEvent final :
 ...
 public:
  ...
  DrmRunJobFtraceEvent* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<DrmRunJobFtraceEvent>(arena);
  }
  DrmRunJobFtraceEvent* New() const {
    return New(nullptr);
  }
  void CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from)  final;
...
class DrmSchedProcessJobFtraceEvent final :
 ...
 public:
  ...
  DrmSchedProcessJobFtraceEvent* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<DrmSchedProcessJobFtraceEvent>(arena);
  }
  DrmSchedProcessJobFtraceEvent* New() const {
    return New(nullptr);
  }
  void CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from)  final;
