...
class FuncgraphEntryFtraceEvent final :
 ...
 public:
  ...
  FuncgraphEntryFtraceEvent* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<FuncgraphEntryFtraceEvent>(arena);
  }
  FuncgraphEntryFtraceEvent* New() const {
    return New(nullptr);
  }
  void CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from)  final;
...
class FuncgraphExitFtraceEvent final :
 ...
 public:
  ...
  FuncgraphExitFtraceEvent* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<FuncgraphExitFtraceEvent>(arena);
  }
  FuncgraphExitFtraceEvent* New() const {
    return New(nullptr);
  }
  void CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from)  final;
...
void PrintFtraceEvent::set_buf(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000001u;
 _impl_.buf_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
