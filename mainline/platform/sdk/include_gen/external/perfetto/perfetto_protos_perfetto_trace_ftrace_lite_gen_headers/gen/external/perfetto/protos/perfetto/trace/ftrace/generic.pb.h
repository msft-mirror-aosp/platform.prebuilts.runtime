...
class GenericFtraceEvent_Field final :
 ...
 public:
  ...
  GenericFtraceEvent_Field* New() const {
    return New(nullptr);
  }
...
// optional string name = 1;
inline bool GenericFtraceEvent_Field::_internal_has_name() const {
...
void GenericFtraceEvent_Field::set_name(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000001u;
...
// string str_value = 3;
inline bool GenericFtraceEvent_Field::_internal_has_str_value() const {
...
template <typename ArgT0, typename... ArgT>
inline void GenericFtraceEvent_Field::set_str_value(ArgT0&& arg0, ArgT... args) {
  if (!_internal_has_str_value()) {
    clear_value();
    set_has_str_value();
...
// int64 int_value = 4;
inline bool GenericFtraceEvent_Field::_internal_has_int_value() const {
...
// uint64 uint_value = 5;
inline bool GenericFtraceEvent_Field::_internal_has_uint_value() const {
...
// optional string event_name = 1;
inline bool GenericFtraceEvent::_internal_has_event_name() const {
  bool value = (_impl_._has_bits_[0] & 0x00000001u) != 0;
  return value;
}
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void GenericFtraceEvent::set_event_name(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000001u;
