...
class DsiCmdFifoStatusFtraceEvent final :
 ...
 public:
  ...
  DsiCmdFifoStatusFtraceEvent* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<DsiCmdFifoStatusFtraceEvent>(arena);
  }
  DsiCmdFifoStatusFtraceEvent* New() const {
    return New(nullptr);
  }
...
class DsiRxFtraceEvent final :
 ...
 public:
  ...
  DsiRxFtraceEvent* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<DsiRxFtraceEvent>(arena);
  }
  DsiRxFtraceEvent* New() const {
    return New(nullptr);
  }
  void CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from)  final;
...
class DsiTxFtraceEvent final :
 ...
 public:
  ...
  DsiTxFtraceEvent* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<DsiTxFtraceEvent>(arena);
  }
  DsiTxFtraceEvent* New() const {
    return New(nullptr);
  }
  void CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from)  final;
