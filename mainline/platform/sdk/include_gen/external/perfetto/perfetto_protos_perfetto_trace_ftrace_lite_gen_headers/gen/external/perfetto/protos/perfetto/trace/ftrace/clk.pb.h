...
class ClkEnableFtraceEvent final :
 ...
 public:
  ...
  ClkEnableFtraceEvent* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<ClkEnableFtraceEvent>(arena);
  }
  ClkEnableFtraceEvent* New() const {
    return New(nullptr);
  }
...
class ClkDisableFtraceEvent final :
 ...
 public:
  ...
  ClkDisableFtraceEvent* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<ClkDisableFtraceEvent>(arena);
  }
  ClkDisableFtraceEvent* New() const {
    return New(nullptr);
  }
  void CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from)  final;
...
class ClkSetRateFtraceEvent final :
 ...
 public:
  ...
  ClkSetRateFtraceEvent* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<ClkSetRateFtraceEvent>(arena);
  }
  ClkSetRateFtraceEvent* New() const {
    return New(nullptr);
  }
  void CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from)  final;
