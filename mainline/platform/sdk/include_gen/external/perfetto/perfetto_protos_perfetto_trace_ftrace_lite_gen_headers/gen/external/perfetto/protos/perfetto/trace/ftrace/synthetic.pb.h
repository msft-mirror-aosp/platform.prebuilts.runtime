...
class RssStatThrottledFtraceEvent final :
 ...
 public:
  ...
  RssStatThrottledFtraceEvent* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<RssStatThrottledFtraceEvent>(arena);
  }
  RssStatThrottledFtraceEvent* New() const {
    return New(nullptr);
  }
...
class SuspendResumeMinimalFtraceEvent final :
 ...
 public:
  ...
  SuspendResumeMinimalFtraceEvent* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<SuspendResumeMinimalFtraceEvent>(arena);
  }
  SuspendResumeMinimalFtraceEvent* New() const {
    return New(nullptr);
  }
  void CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from)  final;
