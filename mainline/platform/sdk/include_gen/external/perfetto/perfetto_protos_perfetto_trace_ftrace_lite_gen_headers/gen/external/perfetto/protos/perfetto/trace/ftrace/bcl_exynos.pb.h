...
class BclIrqTriggerFtraceEvent final :
 ...
 public:
  ...
  inline void Swap(BclIrqTriggerFtraceEvent* other) {
  ...
  BclIrqTriggerFtraceEvent* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<BclIrqTriggerFtraceEvent>(arena);
  }
  BclIrqTriggerFtraceEvent* New() const {
    return New(nullptr);
  }
